...
class Proposal extends Model
{
    ...
    protected $fillable = ['judul_proposal','file_proposal','file_path','kategori_id','status_proposal','layakDiberiAkun','npm_mahasiswa','id_file_revisi_reviewer','file_bukti_pendanaan','file_bukti_path'];
