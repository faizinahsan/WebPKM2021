...
<div class="wrapper">
    ...
    <div id="content">
            ...
            <ul class="timeline-horizontal" id="timeline">
                ...
                <li class="li">
                    <div class="icon-alur-container text-center uploadProposal">
                        ...
                        <br>
                        <span class="status active-status">Upload Proposal</span>
                    </div>
                </li>
                <li class="li">
        ...
        <div class="container container-upload-proposal">
            ...
            <p>Pengumpulan Proposal Liga PKM UNPAD dari tanggal 11 Maret - 6 April 2020. Batas pengumpulan proposal
            ...
            <form id="file-upload-form" action="{{route('mahasiswa-proses_upload_proposal')}}" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="judulProposal" id="judulProposal" class="form-control">
                
                <label for="kategori">Kategori Proposal</label>
                <div class="form-group">
                    <select class="custom-select kategoriPKM", name="kategoriPKM">
            ...
            <!-- End Upload File -->
            @else
                <h5>Proposal Telah di Upload</h1>
                <p>Nama File Proposal: 
